package com.example.visprog_labweek4.data
...
class DataSource {
    ...
    public fun loadStory(): List<Story>{
        return listOf<Story>(
            Story("Your Story", "profile_14"),
            Story("john_doe", "profile_1"),
            Story("jane_smith", "profile_2"),
            Story("alice_johnson", "profile_3"),
            Story("david_williams", "profile_4"),
            Story("emily_brown", "profile_5"),
            Story("michael_davis", "profile_6"),
            Story("susan_jackson", "profile_7"),
            Story("robert_jones", "profile_8"),
            Story("lisa_anderson", "profile_9"),
            Story("william_taylor", "profile_10"),
            Story("elizabeth_martin", "profile_11"),
            Story("james_johnson", "profile_12"),
            Story("natalie_rodriguez", "profile_13"),
            Story("peter_white", "profile_14"),
            Story("olivia_lee", "profile_15"),
            Story("thomas_wilson", "profile_16"),
            Story("grace_martin", "profile_17"),
            Story("jacob_hernandez", "profile_18")
        )
    }
